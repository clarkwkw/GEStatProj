...
class Neural_Network:
	...
	def configure_parameters(self, learning_rate, training_epocs, display_step, save_name):
	...
	def train(self, train_samples_matrix, train_labels, valid_samples_matrix, valid_labels, visualize = False):
