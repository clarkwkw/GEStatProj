...
weights = {
    'h1': tf.Variable(tf.random_normal([_words_count, n_hidden_1]), name = "w_h1"),
...
for k in range(1):
	...
	for i in range(cross_valid):
		...
		#train_matrix, valid_matrix, words = preprocessing.by_idf(train_samples, valid_samples, 5, 45)
		#train_matrix, valid_matrix, words = preprocessing.by_predefined_words(train_samples, valid_samples, _words)
		train_matrix, valid_matrix, words = preprocessing.by_textbook_idf(train_samples, valid_samples, 50, 0)
		#train_matrix, valid_matrix, words = preprocessing.by_textbook_tfidf(train_samples, valid_samples, 50, 0)
